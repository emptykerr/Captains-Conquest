...
public class Constants {
    ...
    public static class Environment {
        ...
        public static final int BIG_CLOUD_WIDTH = (int) (Game.SCALE * BIG_CLOUD_WIDTH_DEFAULT);
        public static final int BIG_CLOUD_HEIGHT = (int) (Game.SCALE * BIG_CLOUD_HEIGHT_DEFAULT);

        public static final int SMALL_CLOUD_WIDTH_DEFAULT = 74;
        public static final int SMALL_CLOUD_HEIGHT_DEFAULT = 24;
        public static final int SMALL_CLOUD_WIDTH = (int) (Game.SCALE * SMALL_CLOUD_WIDTH_DEFAULT);
        public static final int SMALL_CLOUD_HEIGHT = (int) (Game.SCALE * SMALL_CLOUD_HEIGHT_DEFAULT);
    }
